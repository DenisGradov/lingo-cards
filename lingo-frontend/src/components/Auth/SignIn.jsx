  ...
  return (
    <section className="flex flex-col flex-grow px-[10px] justify-center">
      ...
      <div className="mt-[40px]">
        ...
        <h3 className="text-[14px] text-[#9194C3] font-semibold">
          {t('Learn languages easily')}
        </h3>
      </div>
      ...
      <form
        className="big:mt-[120px] mt-[20px] flex flex-col"
        onSubmit={handleSubmit}
      >
        <span className="text-[#9194C3] text-[14px] font-semibold">
          {t('Login')}
        </span>
        <input
        ...
        <div className="mt-4 relative max-w-[100%] w-full">
          ...
          <div className="flex items-center">
            ...
            />
            <div
              className="absolute right-2 cursor-pointer hover:opacity-60"
              onClick={togglePasswordVisibility}
            >
              {showPassword ? (
                <AiFillEyeInvisible size={24} color="#946DFF" />
              ) : (
        ...
        <div className="mt-4">
          <span
            className="text-[16px] font-bold text-[#745BFF] hover:opacity-60 cursor-pointer duration-300"
            onClick={() => {
        ...
        <div className="big:mt-[120px] mt-[20px] flex flex-col items-center">
          ...
          <span className="mt-[24px] text-[#9194C3] text-[14px] font-semibold">
            ...
            <NavLink
              to="/signup"
              className="text-[#000] dark:text-[#fff] text-[14px] font-semibold duration-300 hover:opacity-60 cursor-pointer"
            >
              {t('Register')}{' '}
            </NavLink>
          </span>
