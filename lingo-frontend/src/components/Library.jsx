                  ...
                  return (
                      ...
                      >
                        <div className=" prev-small flex items-center justify-center">
                          <div
                              className="absolute transition duration-300 prev-small bg-gradient-to-b bg-gradient-dark opacity-100 group-hover:opacity-0"></div>
                          <div
                              className="absolute transition duration-300 prev-small bg-gradient-to-b from-[#946DFF]/75 to-[#5A4BFF]/75 opacity-0 group-hover:backdrop-blur-[1px] group-hover:opacity-100"></div>
                          <div className="relative flex flex-col items-center justify-center gap-[6px]">
                            <p className={`font-medium mb-0 ${e.complexity.color}`}>
                              {e.complexity.name}
                            </p>
                            <div
                                className="transition-all duration-300  w-[64px] h-[64px] rounded-3xl flex  items-center justify-center play-hover">
                              <RiPlayLargeLine
                                  className=" transition-all duration-300 text-[30px] text-[#F3F7FF] group-hover:text-[25px]"/>
                            </div>
                            <div className="flex items-center gap-[20px]">
                              ...
                              <div className="flex items-center gap-[10px]">
                                ...
                                <span
                                    className="transition duration-300 font-medium group-hover:text-[#FFE168] text-[#9194C3]">
                              {e.rating}
                            </span>
                              </div>
                            </div>
